...
# [MOD] CAPMD=01 (rising edge), CAPISEL=10 (=2, VCC).  The original io_map.s
# never defined this, so capture_init and capture both wrote CAPMD1_CAPISEL3
# (GND) and the capture input never changed state -> no rising edge -> the
# input-capture unit was never stimulated.  Spec clause 6.ii: CAPISEL
# {0:CAPIN1, 1:CAPIN2, 2:VCC, 3:GND}.
...
.eqv FREQ_5K			  			0x000001F4			# in case of SMCLK=20MHz
