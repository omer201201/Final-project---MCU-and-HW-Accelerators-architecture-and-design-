# run_test3.do -- full-core single-cycle RV32IM sim, running benchmark test3
# Usage in ModelSim:
...
#   - IFETCH.VHD  init_file -> test3/RV32IM .../ITCM.hex
#   - DMEMORY.VHD init_file -> test3/RV32IM .../DTCM.hex
#     (BOTH must point at test3)
#
# Reference (RARS golden):
#   InstructionCounter = 2724 , end-PC = 0x0CC (204) , CLKCNT @ end = 2725
#   IPC = 2724 / 2725 = 0.9996 ~= 1
...
# 5. run from t=0. test3 finishes ~272 us; 500 us leaves margin (end self-loop is harmless).
run 500 us
wave zoom full
