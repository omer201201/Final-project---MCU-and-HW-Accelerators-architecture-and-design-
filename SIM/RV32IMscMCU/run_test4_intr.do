# run_test4_intr.do -- full-system interrupt+timer capture / div-rem accelerator on
#   benchmark "Intrrupt-based IO/test4_modified" (KEY3-driven). Prereq: G_MODELSIM=1.
#     cd C:/Users/omer2/VHDL/Final_Project
#     vsim -c -do SIM/RV32IMscMCU/run_test4_intr.do
...
vcom -2008 TB/RV32IMscMCU/tb_core_test4_intr.vhd

vsim -L altera_mf -L lpm work.tb_core_test4_intr
onerror {quit -f}

add wave -radix unsigned    /tb_core_test4_intr/pc_o
add wave -radix hexadecimal /tb_core_test4_intr/instruction_o
add wave              /tb_core_test4_intr/intr
add wave              /tb_core_test4_intr/btifg
add wave              /tb_core_test4_intr/pwm
add wave              /tb_core_test4_intr/CORE/svc_active_w
add wave -radix hex   /tb_core_test4_intr/CORE/type_captured_q
add wave              /tb_core_test4_intr/PB
